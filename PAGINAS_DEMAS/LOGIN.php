...
<html>
  ...
  <br>
<form action="../funciones/iniciar.php" method="post">
  ...
  <br>
   ...
   <p>Contraseña 
    <input type="password" placeholder="ingrese su contraseña" name="contraseña"></p>
 
 <input class="buttons" type="submit" value="Ingresar">
   <br><br>
   <center><p><a class="link" href="REGISTER.php?user=<?php echo $sett ?>id=<?php echo $registros['id']; ?>">No tengo cuenta. &nbsp REGISTRARSE</a></p></center>
   </form>
